...
import databasecuci.exceptions.NonexistentEntityException;
import databasecuci.exceptions.PreexistingEntityException;
...
public class NyucidongJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.pws_exercise.c.135_jar_0.0.1-SNAPSHOTPU");

    public EntityManager getEntityManager() {
        return emf.createEntityManager();
    }

    public NyucidongJpaController() {
    }
    ...
    public void create(Nyucidong nyucidong) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findNyucidong(nyucidong.getId()) != null) {
